...
bp = Blueprint('catalog_commander', __name__)
...
@bp.route('/api/catalogs/<catalog_name>/schemas', methods=['GET'])
...
@bp.route('/api/catalogs/<catalog_name>/schemas/<schema_name>/tables', methods=['GET'])
...
@bp.route('/api/catalogs/dataset/<path:dataset_path>', methods=['GET'])
...
@bp.route('/api/catalogs/health', methods=['GET'])
def health_check():
