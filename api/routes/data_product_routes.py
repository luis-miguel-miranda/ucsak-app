...
if os.path.exists(yaml_path):
    try:
        ...
        data_products_manager.load_from_yaml(str(yaml_path))
...
async def get_data_product_statuses():
    ...
    try:
        statuses = data_products_manager.get_statuses()
...
async def get_data_product_types():
    ...
    try:
        types = data_products_manager.get_types()
...
async def get_data_product_metadata():
    ...
    try:
        metadata = data_products_manager.get_metadata()
...
async def get_data_product(product_id: str):
    ...
    try:
        product = data_products_manager.get_product(product_id)
        if not product:
...
async def create_data_product(product_data: dict):
    ...
    try:
        ...
        # Create data product
        product = data_products_manager.create_product(
        ...
        try:
            yaml_path = Path(__file__).parent.parent / 'data' / 'data_products.yaml'
            data_products_manager.save_to_yaml(str(yaml_path))
...
async def update_data_product(product_id: str, product_data: dict):
    ...
    try:
        ...
        # Update data product
        updated_product = data_products_manager.update_product(
...
async def delete_data_product(product_id: str):
    ...
    try:
        if not data_products_manager.get_product(product_id):
        ...
        data_products_manager.delete_product(product_id)
